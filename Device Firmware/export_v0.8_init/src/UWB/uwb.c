...
void uwb_thread(void *arg1, void *ard2, void *arg3)
{
    ...
    //printf("Attempting to set SLOW RATE \n");
    port_set_dw1000_slowrate();

    printf("Attempting to CALL INIT\n");
    ...
    printf("Attempting to SET FAST RATE\n");
    port_set_dw1000_fastrate();

    /* Configure GPIOs to not show TX/RX activity. See NOTE 6 below. */
    //dwt_setlnapamode(DWT_LNA_PA_DISABLE); CBT

    /* Configure DW1000. See NOTE 7 below. */
    printf("Attempting to CONFIGURE\n");
